...
public class RestInformationController {
    ...
    public RestResponseDto getIsRegister(int id, int artistId) {
        ...
        restResponseDto.add("RegisteredInformation",
                informationService.getArtistLineUpForCheckRegistered(id, artistId));
        return restResponseDto;
    }
    ...
    public RestResponseDto artistRegisterForLineUpProcess(
            @RequestParam(value = "performance_id", defaultValue = "0") int id,
